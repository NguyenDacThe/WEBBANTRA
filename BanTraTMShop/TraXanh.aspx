<%@ Page Title="" Language="C#" MasterPageFile="~/SitePage.Master" AutoEventWireup="true" CodeBehind="TraXanh.aspx.cs" Inherits="BanTraTMShop.TraXanh" %>
<asp:Content ID="TitleContent3" ContentPlaceHolderID="TitleContent" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <h3 style="padding-left: 20px; margin-bottom: 5px">Trà Xanh</h3>
