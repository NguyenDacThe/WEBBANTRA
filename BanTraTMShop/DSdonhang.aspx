<%@ Page Title="" Language="C#" MasterPageFile="~/SitePage.Master" AutoEventWireup="true" CodeBehind="DSdonhang.aspx.cs" Inherits="BanTraTMShop.DSdonhang" %>
...
<div>
    ...
    <asp:GridView ID="gvOrders" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:Button ID="btnViewOrder" runat="server" CommandName="ViewOrder" CommandArgument='<%# Eval("maDonHang") %>' Text="Xem" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
