<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="BanTraTMShop.Login" %>
...
<head runat="server">
    ...
    <style>
    body {
        background-image: url('<%= ResolveUrl("~/image/tra2.jpg") %>');
...
<body>
    ...
    <div class="login-container">
        ...
        <!-- Username Field -->
        <label for="txthoTen">Username:</label>
        <asp:TextBox ID="txthoTen" runat="server" CssClass="form-control" placeholder="Nhập tài khoản" />

        <!-- Password Field -->
        <label for="txtmatKhau">Password:</label>
        <asp:TextBox ID="txtmatKhau" runat="server" TextMode="Password" CssClass="form-control" placeholder="Nhập password" />
